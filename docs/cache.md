...
The scope list comes from an unlocked read of `manifest.json`, which is
written atomically. A lock file that cannot be opened for writing does not
prevent this schema check.
