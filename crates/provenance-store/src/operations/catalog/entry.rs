...
pub(super) fn entries() -> Vec<Entry> {
    vec![
        ...
        register::<super::RequirementEditStateOperation>(),
        register::<super::SaveRequirementOperation>(),
        register::<super::RequirementSaveReceiptOperation>(),
        register::<super::ReviewHistoryOperation>(),
        register::<super::ReviewEvidenceOperation>(),
        register::<super::CreateReviewRequirementOperation>(),
        register::<super::RequirementCreationReceiptOperation>(),
        register::<super::WriteDiscussionOperation>(),
        register::<super::DiscussionReceiptOperation>(),
        register::<super::ReviewDiscussionsOperation>(),
        register::<super::ReviewDiscussionMessagesOperation>(),
        register::<super::SubmitRequirementReviewOperation>(),
        register::<super::DecideRequirementReviewOperation>(),
        register::<super::WithdrawRequirementReviewOperation>(),
        register::<super::RequirementDecisionStateOperation>(),
        register::<super::RequirementReviewReceiptOperation>(),
    ]
}
