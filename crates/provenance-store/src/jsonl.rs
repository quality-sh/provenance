...
///
/// The raw line stays with its typed record. Unchanged records use the raw line
/// when the shard is saved. A changed record keeps unknown top-level fields.
/// The write is refused if unknown nested data cannot be associated safely
