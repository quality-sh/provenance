use provenance_core::protocol::{
    Direction, ImpactQuery, QueryResponse, RecordResolution as CoreRecordResolution, ResponseMeta,
    ResolveRecordQuery, ResolveRecordResult, TraceQuery,
};
...
impl GetPort for HostGetPort {
    ...
    fn impact<'a>(
        ...
        Box::pin(async move {
            if self.permitted_node_types().len() != NodeType::ALL.len() {
