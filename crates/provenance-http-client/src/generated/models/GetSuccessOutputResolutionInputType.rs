...
pub enum GetSuccessOutputResolutionInputType {
...
impl ::std::fmt::Display for GetSuccessOutputResolutionInputType {
...
impl ::std::str::FromStr for GetSuccessOutputResolutionInputType {
...
impl ::std::convert::TryFrom<&str> for GetSuccessOutputResolutionInputType {
...
for GetSuccessOutputResolutionInputType {
    type Error = self::error::ConversionError;
    fn try_from(
