...
pub enum ImpactRequestInputNodeType {
    #[serde(rename = "source")]
    Source,
...
impl ::std::fmt::Display for ImpactRequestInputNodeType {
...
impl ::std::str::FromStr for ImpactRequestInputNodeType {
...
impl ::std::convert::TryFrom<&str> for ImpactRequestInputNodeType {
...
impl ::std::convert::TryFrom<&::std::string::String> for ImpactRequestInputNodeType {
    type Error = self::error::ConversionError;
    fn try_from(
