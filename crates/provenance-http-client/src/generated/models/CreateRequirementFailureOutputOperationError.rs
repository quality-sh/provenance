...
#[serde(tag = "kind")]
pub enum CreateRequirementFailureOutputOperationError {
    #[serde(rename = "invalid_input")]
    InvalidInput {
        field: ::std::option::Option<::std::string::String>,
        reason: CreateRequirementFailureOutputInvalidInputReason,
    },
    ...
    StatementInvalid { report: CreateRequirementFailureOutputReport },
    #[serde(rename = "invalid_declaration")]
    InvalidDeclaration,
    #[serde(rename = "ownership_conflict")]
    OwnershipConflict {
        conflicts: ::std::vec::Vec<CreateRequirementFailureOutputReconciledResource>,
    },
    #[serde(rename = "missing_reference")]
    MissingReference,
    #[serde(rename = "statement_rejected")]
    StatementRejected {
        diagnostics: ::std::vec::Vec<CreateRequirementFailureOutputTypedSpecDiagnostic>,
    },
