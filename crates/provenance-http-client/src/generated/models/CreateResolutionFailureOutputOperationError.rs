...
#[serde(tag = "kind")]
pub enum CreateResolutionFailureOutputOperationError {
    #[serde(rename = "invalid_input")]
    InvalidInput {
        field: ::std::option::Option<::std::string::String>,
        reason: CreateResolutionFailureOutputInvalidInputReason,
    },
    ...
    StatementInvalid { report: CreateResolutionFailureOutputReport },
    #[serde(rename = "invalid_declaration")]
    InvalidDeclaration,
    #[serde(rename = "ownership_conflict")]
    OwnershipConflict {
        conflicts: ::std::vec::Vec<CreateResolutionFailureOutputReconciledResource>,
    },
    #[serde(rename = "missing_reference")]
    MissingReference,
    #[serde(rename = "statement_rejected")]
    StatementRejected {
        diagnostics: ::std::vec::Vec<CreateResolutionFailureOutputTypedSpecDiagnostic>,
    },
