...
pub enum TraceSuccessOutputResolutionInputType {
...
impl ::std::fmt::Display for TraceSuccessOutputResolutionInputType {
...
impl ::std::str::FromStr for TraceSuccessOutputResolutionInputType {
...
impl ::std::convert::TryFrom<&str> for TraceSuccessOutputResolutionInputType {
...
for TraceSuccessOutputResolutionInputType {
    type Error = self::error::ConversionError;
    fn try_from(
