...
#[serde(tag = "kind")]
pub enum PlanFailureOutputOperationError {
    #[serde(rename = "invalid_input")]
    InvalidInput {
        field: ::std::option::Option<::std::string::String>,
        reason: PlanFailureOutputInvalidInputReason,
    },
    ...
    OwnershipConflict {
        conflicts: ::std::vec::Vec<PlanFailureOutputReconciledResource>,
    },
    #[serde(rename = "missing_reference")]
    MissingReference,
    #[serde(rename = "statement_rejected")]
    StatementRejected {
        diagnostics: ::std::vec::Vec<PlanFailureOutputTypedSpecDiagnostic>,
    },
