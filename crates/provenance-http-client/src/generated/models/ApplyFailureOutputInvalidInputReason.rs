...
pub enum ApplyFailureOutputInvalidInputReason {
...
impl ::std::fmt::Display for ApplyFailureOutputInvalidInputReason {
...
impl ::std::str::FromStr for ApplyFailureOutputInvalidInputReason {
...
impl ::std::convert::TryFrom<&str> for ApplyFailureOutputInvalidInputReason {
...
for ApplyFailureOutputInvalidInputReason {
    type Error = self::error::ConversionError;
    fn try_from(
