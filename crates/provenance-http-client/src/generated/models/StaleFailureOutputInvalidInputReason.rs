...
pub enum StaleFailureOutputInvalidInputReason {
...
impl ::std::fmt::Display for StaleFailureOutputInvalidInputReason {
...
impl ::std::str::FromStr for StaleFailureOutputInvalidInputReason {
...
impl ::std::convert::TryFrom<&str> for StaleFailureOutputInvalidInputReason {
...
for StaleFailureOutputInvalidInputReason {
    type Error = self::error::ConversionError;
    fn try_from(
