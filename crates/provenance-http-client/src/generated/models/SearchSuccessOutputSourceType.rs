...
pub enum SearchSuccessOutputSourceType {
    #[serde(rename = "policy")]
    Policy,
...
impl ::std::fmt::Display for SearchSuccessOutputSourceType {
...
impl ::std::str::FromStr for SearchSuccessOutputSourceType {
...
impl ::std::convert::TryFrom<&str> for SearchSuccessOutputSourceType {
...
impl ::std::convert::TryFrom<&::std::string::String> for SearchSuccessOutputSourceType {
    type Error = self::error::ConversionError;
    fn try_from(
