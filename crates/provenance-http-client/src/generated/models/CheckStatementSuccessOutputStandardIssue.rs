...
#[serde(transparent)]
pub struct CheckStatementSuccessOutputStandardIssue(u8);
impl ::std::ops::Deref for CheckStatementSuccessOutputStandardIssue {
    type Target = u8;
    fn deref(&self) -> &u8 {
        &self.0
    }
...
impl<'de> ::serde::Deserialize<'de> for CheckStatementSuccessOutputStandardIssue {
