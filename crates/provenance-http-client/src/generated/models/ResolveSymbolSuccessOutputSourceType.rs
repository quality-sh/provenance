...
pub enum ResolveSymbolSuccessOutputSourceType {
    #[serde(rename = "policy")]
    Policy,
...
impl ::std::fmt::Display for ResolveSymbolSuccessOutputSourceType {
...
impl ::std::str::FromStr for ResolveSymbolSuccessOutputSourceType {
...
impl ::std::convert::TryFrom<&str> for ResolveSymbolSuccessOutputSourceType {
...
for ResolveSymbolSuccessOutputSourceType {
    type Error = self::error::ConversionError;
    fn try_from(
