...
pub enum GetSuccessOutputSourceType {
    #[serde(rename = "policy")]
    Policy,
...
impl ::std::fmt::Display for GetSuccessOutputSourceType {
...
impl ::std::str::FromStr for GetSuccessOutputSourceType {
...
impl ::std::convert::TryFrom<&str> for GetSuccessOutputSourceType {
...
impl ::std::convert::TryFrom<&::std::string::String> for GetSuccessOutputSourceType {
    type Error = self::error::ConversionError;
    fn try_from(
