...
pub enum InfoFailureOutputInvalidInputReason {
...
impl ::std::fmt::Display for InfoFailureOutputInvalidInputReason {
...
impl ::std::str::FromStr for InfoFailureOutputInvalidInputReason {
...
impl ::std::convert::TryFrom<&str> for InfoFailureOutputInvalidInputReason {
...
for InfoFailureOutputInvalidInputReason {
    type Error = self::error::ConversionError;
    fn try_from(
