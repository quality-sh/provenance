...
pub struct SearchSuccessOutputRule {
    ...
    pub requirement_ids: ::std::vec::Vec<SearchSuccessOutputStableId>,
    #[serde(default, skip_serializing_if = "::std::vec::Vec::is_empty")]
    pub resolution_ids: ::std::vec::Vec<SearchSuccessOutputStableId>,
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    pub retired: ::std::option::Option<bool>,
    pub schema_version: u32,
    pub scope_id: SearchSuccessOutputScopeId,
    pub severity: SearchSuccessOutputRuleSeverity,
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    ...
    pub status: SearchSuccessOutputRuleStatus,
}
