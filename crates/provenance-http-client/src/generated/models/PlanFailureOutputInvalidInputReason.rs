...
pub enum PlanFailureOutputInvalidInputReason {
...
impl ::std::fmt::Display for PlanFailureOutputInvalidInputReason {
...
impl ::std::str::FromStr for PlanFailureOutputInvalidInputReason {
...
impl ::std::convert::TryFrom<&str> for PlanFailureOutputInvalidInputReason {
...
for PlanFailureOutputInvalidInputReason {
    type Error = self::error::ConversionError;
    fn try_from(
