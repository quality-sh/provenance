...
pub enum CreateSourceRequestInputSourceType {
    #[serde(rename = "policy")]
    Policy,
...
impl ::std::fmt::Display for CreateSourceRequestInputSourceType {
...
impl ::std::str::FromStr for CreateSourceRequestInputSourceType {
...
impl ::std::convert::TryFrom<&str> for CreateSourceRequestInputSourceType {
...
for CreateSourceRequestInputSourceType {
    type Error = self::error::ConversionError;
    fn try_from(
