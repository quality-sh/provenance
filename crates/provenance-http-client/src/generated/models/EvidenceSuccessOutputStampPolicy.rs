...
pub enum EvidenceSuccessOutputStampPolicy {
...
impl ::std::fmt::Display for EvidenceSuccessOutputStampPolicy {
...
impl ::std::str::FromStr for EvidenceSuccessOutputStampPolicy {
...
impl ::std::convert::TryFrom<&str> for EvidenceSuccessOutputStampPolicy {
...
for EvidenceSuccessOutputStampPolicy {
    type Error = self::error::ConversionError;
    fn try_from(
