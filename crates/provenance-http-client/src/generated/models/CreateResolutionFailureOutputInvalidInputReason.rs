...
pub enum CreateResolutionFailureOutputInvalidInputReason {
...
impl ::std::fmt::Display for CreateResolutionFailureOutputInvalidInputReason {
...
impl ::std::str::FromStr for CreateResolutionFailureOutputInvalidInputReason {
...
impl ::std::convert::TryFrom<&str> for CreateResolutionFailureOutputInvalidInputReason {
...
for CreateResolutionFailureOutputInvalidInputReason {
    type Error = self::error::ConversionError;
    fn try_from(
