...
pub enum ResolveSymbolSuccessOutputStampPolicy {
...
impl ::std::fmt::Display for ResolveSymbolSuccessOutputStampPolicy {
...
impl ::std::str::FromStr for ResolveSymbolSuccessOutputStampPolicy {
...
impl ::std::convert::TryFrom<&str> for ResolveSymbolSuccessOutputStampPolicy {
...
for ResolveSymbolSuccessOutputStampPolicy {
    type Error = self::error::ConversionError;
    fn try_from(
