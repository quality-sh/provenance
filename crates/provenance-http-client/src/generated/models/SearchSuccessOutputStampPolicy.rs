...
pub enum SearchSuccessOutputStampPolicy {
...
impl ::std::fmt::Display for SearchSuccessOutputStampPolicy {
...
impl ::std::str::FromStr for SearchSuccessOutputStampPolicy {
...
impl ::std::convert::TryFrom<&str> for SearchSuccessOutputStampPolicy {
...
impl ::std::convert::TryFrom<&::std::string::String> for SearchSuccessOutputStampPolicy {
    type Error = self::error::ConversionError;
    fn try_from(
