...
pub enum NeighborsSuccessOutputResolutionInputType {
...
impl ::std::fmt::Display for NeighborsSuccessOutputResolutionInputType {
...
impl ::std::str::FromStr for NeighborsSuccessOutputResolutionInputType {
...
impl ::std::convert::TryFrom<&str> for NeighborsSuccessOutputResolutionInputType {
...
for NeighborsSuccessOutputResolutionInputType {
    type Error = self::error::ConversionError;
    fn try_from(
