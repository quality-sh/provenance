...
pub enum CreateResolutionSuccessOutputResolutionInputType {
...
impl ::std::fmt::Display for CreateResolutionSuccessOutputResolutionInputType {
...
impl ::std::str::FromStr for CreateResolutionSuccessOutputResolutionInputType {
...
impl ::std::convert::TryFrom<&str> for CreateResolutionSuccessOutputResolutionInputType {
...
for CreateResolutionSuccessOutputResolutionInputType {
    type Error = self::error::ConversionError;
    fn try_from(
