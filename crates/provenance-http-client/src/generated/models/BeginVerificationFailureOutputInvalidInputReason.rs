...
pub enum BeginVerificationFailureOutputInvalidInputReason {
...
impl ::std::fmt::Display for BeginVerificationFailureOutputInvalidInputReason {
...
impl ::std::str::FromStr for BeginVerificationFailureOutputInvalidInputReason {
...
impl ::std::convert::TryFrom<&str> for BeginVerificationFailureOutputInvalidInputReason {
...
for BeginVerificationFailureOutputInvalidInputReason {
    type Error = self::error::ConversionError;
    fn try_from(
