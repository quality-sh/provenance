...
pub enum TraceSuccessOutputStampPolicy {
...
impl ::std::fmt::Display for TraceSuccessOutputStampPolicy {
...
impl ::std::str::FromStr for TraceSuccessOutputStampPolicy {
...
impl ::std::convert::TryFrom<&str> for TraceSuccessOutputStampPolicy {
...
impl ::std::convert::TryFrom<&::std::string::String> for TraceSuccessOutputStampPolicy {
    type Error = self::error::ConversionError;
    fn try_from(
