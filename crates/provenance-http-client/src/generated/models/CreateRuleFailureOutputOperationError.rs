...
#[serde(tag = "kind")]
pub enum CreateRuleFailureOutputOperationError {
    ...
    StatementInvalid { report: CreateRuleFailureOutputReport },
    #[serde(rename = "invalid_declaration")]
    InvalidDeclaration,
    #[serde(rename = "ownership_conflict")]
    OwnershipConflict {
        conflicts: ::std::vec::Vec<CreateRuleFailureOutputReconciledResource>,
    },
    #[serde(rename = "missing_reference")]
    MissingReference,
    #[serde(rename = "statement_rejected")]
    StatementRejected {
        diagnostics: ::std::vec::Vec<CreateRuleFailureOutputTypedSpecDiagnostic>,
    },
