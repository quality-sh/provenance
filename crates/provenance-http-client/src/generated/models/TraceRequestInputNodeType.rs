...
pub enum TraceRequestInputNodeType {
    #[serde(rename = "source")]
    Source,
...
impl ::std::fmt::Display for TraceRequestInputNodeType {
...
impl ::std::str::FromStr for TraceRequestInputNodeType {
...
impl ::std::convert::TryFrom<&str> for TraceRequestInputNodeType {
...
impl ::std::convert::TryFrom<&::std::string::String> for TraceRequestInputNodeType {
    type Error = self::error::ConversionError;
    fn try_from(
