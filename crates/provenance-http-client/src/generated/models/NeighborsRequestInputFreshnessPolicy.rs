...
pub enum NeighborsRequestInputFreshnessPolicy {
...
impl ::std::fmt::Display for NeighborsRequestInputFreshnessPolicy {
...
impl ::std::str::FromStr for NeighborsRequestInputFreshnessPolicy {
...
impl ::std::convert::TryFrom<&str> for NeighborsRequestInputFreshnessPolicy {
...
for NeighborsRequestInputFreshnessPolicy {
    type Error = self::error::ConversionError;
    fn try_from(
