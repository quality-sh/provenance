...
pub enum EvidenceSuccessOutputEvidenceSiteKind {
...
impl ::std::fmt::Display for EvidenceSuccessOutputEvidenceSiteKind {
...
impl ::std::str::FromStr for EvidenceSuccessOutputEvidenceSiteKind {
...
impl ::std::convert::TryFrom<&str> for EvidenceSuccessOutputEvidenceSiteKind {
...
for EvidenceSuccessOutputEvidenceSiteKind {
    type Error = self::error::ConversionError;
    fn try_from(
