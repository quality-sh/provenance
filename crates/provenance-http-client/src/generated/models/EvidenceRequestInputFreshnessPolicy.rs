...
pub enum EvidenceRequestInputFreshnessPolicy {
...
impl ::std::fmt::Display for EvidenceRequestInputFreshnessPolicy {
...
impl ::std::str::FromStr for EvidenceRequestInputFreshnessPolicy {
...
impl ::std::convert::TryFrom<&str> for EvidenceRequestInputFreshnessPolicy {
...
for EvidenceRequestInputFreshnessPolicy {
    type Error = self::error::ConversionError;
    fn try_from(
