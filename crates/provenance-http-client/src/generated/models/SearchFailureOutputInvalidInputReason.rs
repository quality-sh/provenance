...
pub enum SearchFailureOutputInvalidInputReason {
...
impl ::std::fmt::Display for SearchFailureOutputInvalidInputReason {
...
impl ::std::str::FromStr for SearchFailureOutputInvalidInputReason {
...
impl ::std::convert::TryFrom<&str> for SearchFailureOutputInvalidInputReason {
...
for SearchFailureOutputInvalidInputReason {
    type Error = self::error::ConversionError;
    fn try_from(
