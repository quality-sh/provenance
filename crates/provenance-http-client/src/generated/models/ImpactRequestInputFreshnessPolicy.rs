...
pub enum ImpactRequestInputFreshnessPolicy {
...
impl ::std::fmt::Display for ImpactRequestInputFreshnessPolicy {
...
impl ::std::str::FromStr for ImpactRequestInputFreshnessPolicy {
...
impl ::std::convert::TryFrom<&str> for ImpactRequestInputFreshnessPolicy {
...
for ImpactRequestInputFreshnessPolicy {
    type Error = self::error::ConversionError;
    fn try_from(
