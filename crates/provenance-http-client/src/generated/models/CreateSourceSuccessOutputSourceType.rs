...
pub enum CreateSourceSuccessOutputSourceType {
    #[serde(rename = "policy")]
    Policy,
...
impl ::std::fmt::Display for CreateSourceSuccessOutputSourceType {
...
impl ::std::str::FromStr for CreateSourceSuccessOutputSourceType {
...
impl ::std::convert::TryFrom<&str> for CreateSourceSuccessOutputSourceType {
...
for CreateSourceSuccessOutputSourceType {
    type Error = self::error::ConversionError;
    fn try_from(
