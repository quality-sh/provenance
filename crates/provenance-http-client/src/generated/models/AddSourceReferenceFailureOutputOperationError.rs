...
#[serde(tag = "kind")]
pub enum AddSourceReferenceFailureOutputOperationError {
    #[serde(rename = "invalid_input")]
    InvalidInput {
        field: ::std::option::Option<::std::string::String>,
        reason: AddSourceReferenceFailureOutputInvalidInputReason,
    },
    ...
    StatementInvalid { report: AddSourceReferenceFailureOutputReport },
    #[serde(rename = "invalid_declaration")]
    InvalidDeclaration,
    #[serde(rename = "ownership_conflict")]
    OwnershipConflict {
        conflicts: ::std::vec::Vec<AddSourceReferenceFailureOutputReconciledResource>,
    },
    #[serde(rename = "missing_reference")]
    MissingReference,
    #[serde(rename = "statement_rejected")]
    StatementRejected {
        diagnostics: ::std::vec::Vec<AddSourceReferenceFailureOutputTypedSpecDiagnostic>,
    },
