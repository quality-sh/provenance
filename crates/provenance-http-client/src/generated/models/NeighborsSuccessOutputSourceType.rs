...
pub enum NeighborsSuccessOutputSourceType {
    #[serde(rename = "policy")]
    Policy,
...
impl ::std::fmt::Display for NeighborsSuccessOutputSourceType {
...
impl ::std::str::FromStr for NeighborsSuccessOutputSourceType {
...
impl ::std::convert::TryFrom<&str> for NeighborsSuccessOutputSourceType {
...
for NeighborsSuccessOutputSourceType {
    type Error = self::error::ConversionError;
    fn try_from(
