...
pub enum NeighborsSuccessOutputStampPolicy {
...
impl ::std::fmt::Display for NeighborsSuccessOutputStampPolicy {
...
impl ::std::str::FromStr for NeighborsSuccessOutputStampPolicy {
...
impl ::std::convert::TryFrom<&str> for NeighborsSuccessOutputStampPolicy {
...
for NeighborsSuccessOutputStampPolicy {
    type Error = self::error::ConversionError;
    fn try_from(
