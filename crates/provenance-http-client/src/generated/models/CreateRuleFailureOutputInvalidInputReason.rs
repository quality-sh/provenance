...
pub enum CreateRuleFailureOutputInvalidInputReason {
...
impl ::std::fmt::Display for CreateRuleFailureOutputInvalidInputReason {
...
impl ::std::str::FromStr for CreateRuleFailureOutputInvalidInputReason {
...
impl ::std::convert::TryFrom<&str> for CreateRuleFailureOutputInvalidInputReason {
...
for CreateRuleFailureOutputInvalidInputReason {
    type Error = self::error::ConversionError;
    fn try_from(
