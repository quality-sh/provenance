...
pub enum SearchSuccessOutputResolutionInputType {
...
impl ::std::fmt::Display for SearchSuccessOutputResolutionInputType {
...
impl ::std::str::FromStr for SearchSuccessOutputResolutionInputType {
...
impl ::std::convert::TryFrom<&str> for SearchSuccessOutputResolutionInputType {
...
for SearchSuccessOutputResolutionInputType {
    type Error = self::error::ConversionError;
    fn try_from(
