...
pub enum CreateSourceFailureOutputInvalidInputReason {
...
impl ::std::fmt::Display for CreateSourceFailureOutputInvalidInputReason {
...
impl ::std::str::FromStr for CreateSourceFailureOutputInvalidInputReason {
...
impl ::std::convert::TryFrom<&str> for CreateSourceFailureOutputInvalidInputReason {
...
for CreateSourceFailureOutputInvalidInputReason {
    type Error = self::error::ConversionError;
    fn try_from(
