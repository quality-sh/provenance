...
pub enum GetRequestInputFreshnessPolicy {
...
impl ::std::fmt::Display for GetRequestInputFreshnessPolicy {
...
impl ::std::str::FromStr for GetRequestInputFreshnessPolicy {
...
impl ::std::convert::TryFrom<&str> for GetRequestInputFreshnessPolicy {
...
impl ::std::convert::TryFrom<&::std::string::String> for GetRequestInputFreshnessPolicy {
    type Error = self::error::ConversionError;
    fn try_from(
