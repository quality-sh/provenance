...
pub enum GetSuccessOutputStampPolicy {
...
impl ::std::fmt::Display for GetSuccessOutputStampPolicy {
...
impl ::std::str::FromStr for GetSuccessOutputStampPolicy {
...
impl ::std::convert::TryFrom<&str> for GetSuccessOutputStampPolicy {
...
impl ::std::convert::TryFrom<&::std::string::String> for GetSuccessOutputStampPolicy {
    type Error = self::error::ConversionError;
    fn try_from(
