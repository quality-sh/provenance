...
pub enum NeighborsFailureOutputInvalidInputReason {
...
impl ::std::fmt::Display for NeighborsFailureOutputInvalidInputReason {
...
impl ::std::str::FromStr for NeighborsFailureOutputInvalidInputReason {
...
impl ::std::convert::TryFrom<&str> for NeighborsFailureOutputInvalidInputReason {
...
for NeighborsFailureOutputInvalidInputReason {
    type Error = self::error::ConversionError;
    fn try_from(
