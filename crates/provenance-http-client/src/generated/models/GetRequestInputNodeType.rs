...
pub enum GetRequestInputNodeType {
    #[serde(rename = "source")]
    Source,
...
impl ::std::fmt::Display for GetRequestInputNodeType {
...
impl ::std::str::FromStr for GetRequestInputNodeType {
...
impl ::std::convert::TryFrom<&str> for GetRequestInputNodeType {
...
impl ::std::convert::TryFrom<&::std::string::String> for GetRequestInputNodeType {
    type Error = self::error::ConversionError;
    fn try_from(
