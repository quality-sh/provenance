...
pub enum ImpactSuccessOutputStampPolicy {
...
impl ::std::fmt::Display for ImpactSuccessOutputStampPolicy {
...
impl ::std::str::FromStr for ImpactSuccessOutputStampPolicy {
...
impl ::std::convert::TryFrom<&str> for ImpactSuccessOutputStampPolicy {
...
impl ::std::convert::TryFrom<&::std::string::String> for ImpactSuccessOutputStampPolicy {
    type Error = self::error::ConversionError;
    fn try_from(
