...
pub enum StaleRequestInputFreshnessPolicy {
...
impl ::std::fmt::Display for StaleRequestInputFreshnessPolicy {
...
impl ::std::str::FromStr for StaleRequestInputFreshnessPolicy {
...
impl ::std::convert::TryFrom<&str> for StaleRequestInputFreshnessPolicy {
...
for StaleRequestInputFreshnessPolicy {
    type Error = self::error::ConversionError;
    fn try_from(
