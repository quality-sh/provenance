...
pub enum ImpactFailureOutputInvalidInputReason {
...
impl ::std::fmt::Display for ImpactFailureOutputInvalidInputReason {
...
impl ::std::str::FromStr for ImpactFailureOutputInvalidInputReason {
...
impl ::std::convert::TryFrom<&str> for ImpactFailureOutputInvalidInputReason {
...
for ImpactFailureOutputInvalidInputReason {
    type Error = self::error::ConversionError;
    fn try_from(
