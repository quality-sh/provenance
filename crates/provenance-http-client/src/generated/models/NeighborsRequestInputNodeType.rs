...
pub enum NeighborsRequestInputNodeType {
    #[serde(rename = "source")]
    Source,
...
impl ::std::fmt::Display for NeighborsRequestInputNodeType {
...
impl ::std::str::FromStr for NeighborsRequestInputNodeType {
...
impl ::std::convert::TryFrom<&str> for NeighborsRequestInputNodeType {
...
impl ::std::convert::TryFrom<&::std::string::String> for NeighborsRequestInputNodeType {
    type Error = self::error::ConversionError;
    fn try_from(
