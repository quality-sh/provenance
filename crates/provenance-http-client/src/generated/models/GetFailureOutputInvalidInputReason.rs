...
pub enum GetFailureOutputInvalidInputReason {
...
impl ::std::fmt::Display for GetFailureOutputInvalidInputReason {
...
impl ::std::str::FromStr for GetFailureOutputInvalidInputReason {
...
impl ::std::convert::TryFrom<&str> for GetFailureOutputInvalidInputReason {
...
for GetFailureOutputInvalidInputReason {
    type Error = self::error::ConversionError;
    fn try_from(
