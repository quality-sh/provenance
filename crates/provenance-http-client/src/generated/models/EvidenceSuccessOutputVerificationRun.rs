...
pub struct EvidenceSuccessOutputVerificationRun {
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    pub binding_id: ::std::option::Option<EvidenceSuccessOutputStableId>,
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
    ...
    pub started_at: i64,
    pub status: EvidenceSuccessOutputVerificationRunStatus,
    #[serde(default, skip_serializing_if = "::std::option::Option::is_none")]
