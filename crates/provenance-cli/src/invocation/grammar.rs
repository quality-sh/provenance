...
use clap::{
    builder::{PossibleValuesParser, TypedValueParser}, ArgAction, ArgMatches, Args, Command, CommandFactory,
...
impl TargetVerb {
    ...
    pub const fn is_legacy_record(self) -> bool {
        matches!(self, Self::Get | Self::Record(_))
    }
}
